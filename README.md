...
root
 ...
 |
 └─── scripts
         Main folder for user sync script
```
...
|--|--|--|
| mi-github-script-signing | kv-codesigning-ikt-01: [ikt] Key Vault Crypto User <br> kv-codesigning-ikt-01: Contributer | Contributer is only temporary, and shall be removed once private endpoint access is configured. |
